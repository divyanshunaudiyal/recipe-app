...
return 7!==Object.defineProperty({},1,{get:function(){return 7}})[1]});var L={},k={};k=!O(function(){// eslint-disable-next-line es/no-function-prototype-bind -- safe
var e=(function(){}).bind();// eslint-disable-next-line no-prototype-builtins -- safe
return"function"!=typeof e||e.hasOwnProperty("prototype")});var x=Function.prototype.call;L=k?x.bind(x):function(){return x.apply(x,arguments)};var T={}.propertyIsEnumerable,M=Object.getOwnPropertyDescriptor;n=M&&!T.call({1:2},1)?function(e){var t=M(this,e);return!!t&&t.enumerable}:T;var P={};P=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var $={},I={},F={},D=Function.prototype,q=D.call,A=k&&D.bind.bind(q,q),H={},R=(F=k?A:function(e){return function(){return q.apply(e,arguments)}})({}.toString),N=F("".slice);H=function(e){return N(R(e),8,-1)};var C=Object,G=F("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
...
em=function(e,t){var r,n;if("string"===t&&K(r=e.toString)&&!Q(n=L(r,e))||K(r=e.valueOf)&&!Q(n=L(r,e))||"string"!==t&&K(r=e.toString)&&!Q(n=L(r,e)))return n;throw e_("Can't convert object to primitive value")};var eb={},ew={};ew=!1;var eE={},eS={},ej=Object.defineProperty;eS=function(e,t){try{ej(E,e,{value:t,configurable:!0,writable:!0})}catch(r){E[e]=t}return t};var eO="__core-js_shared__";eE=E[eO]||eS(eO,{}),(eb=function(e,t){return eE[e]||(eE[e]=void 0!==t?t:{})})("versions",[]).push({version:"3.32.2",mode:ew?"pure":"global",copyright:"\xa9 2014-2023 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.32.2/LICENSE",source:"https://github.com/zloirock/core-js"});var eL={},ek={},ex=Object;// `ToObject` abstract operation
// https://tc39.es/ecma262/#sec-toobject
ek=function(e){return ex(U(e))};var eT=F({}.hasOwnProperty);// `HasOwnProperty` abstract operation
// https://tc39.es/ecma262/#sec-hasownproperty
// eslint-disable-next-line es/no-object-hasown -- safe
eL=Object.hasOwn||function(e,t){return eT(ek(e),t)};var eM={},eP=0,e$=Math.random(),eI=F(1..toString);eM=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eI(++eP+e$,36)};var eF=E.Symbol,eD=eb("wks"),eq=en?eF.for||eF:eF&&eF.withoutSetter||eM,eA=TypeError,eH=(eL(eD,e="toPrimitive")||(eD[e]=ei&&eL(eF,e)?eF[e]:eq("Symbol."+e)),eD[e]);// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
Y=function(e,t){if(!Q(e)||ee(e))return e;var r,n=eh(e,eH);if(n){if(void 0===t&&(t="default"),r=L(n,e,t),!Q(r)||ee(r))return r;throw eA("Can't convert object to primitive value")}return void 0===t&&(t="number"),em(e,t)},// `ToPropertyKey` abstract operation
...
var eU=Object.getOwnPropertyDescriptor;r=j?eU:function(e,t){if(e=$(e),t=W(t),eR)try{return eU(e,t)}catch(e){}if(eL(e,t))return P(!L(n,e,t),e[t])};var ez={},eB={};// V8 ~ Chrome 36-
...
eW=function(e){if(Q(e))return e;throw eQ(eY(e)+" is not an object")};var eK=TypeError,eV=Object.defineProperty,eJ=Object.getOwnPropertyDescriptor,eX="enumerable",eZ="configurable",e0="writable";a=j?eB?function(e,t,r){if(eW(e),t=W(t),eW(r),"function"==typeof e&&"prototype"===t&&"value"in r&&e0 in r&&!r[e0]){var n=eJ(e,t);n&&n[e0]&&(e[t]=r.value,r={configurable:eZ in r?r[eZ]:n[eZ],enumerable:eX in r?r[eX]:n[eX],writable:!1})}return eV(e,t,r)}:eV:function(e,t,r){if(eW(e),t=W(t),eW(r),eR)try{return eV(e,t,r)}catch(e){}if("get"in r||"set"in r)throw eK("Accessors not supported");return"value"in r&&(e[t]=r.value),e},ez=j?function(e,t,r){return a(e,t,P(1,r))}:function(e,t,r){return e[t]=r,e};var e1={},e2={},e4=Function.prototype,e3=j&&Object.getOwnPropertyDescriptor,e7=eL(e4,"name")&&(!j||j&&e3(e4,"name").configurable),e8={},e9=F(Function.toString);K(eE.inspectSource)||(eE.inspectSource=function(e){return e9(e)}),e8=eE.inspectSource;var e5={},e6={},te=E.WeakMap;e6=K(te)&&/native code/.test(String(te));var tt={},tr=eb("keys");tt=function(e){return tr[e]||(tr[e]=eM(e))};var tn={};tn={};var ti="Object already initialized",to=E.TypeError,ta=E.WeakMap;if(e6||eE.state){var tc=eE.state||(eE.state=new ta);/* eslint-disable no-self-assign -- prototype methods protection */tc.get=tc.get,tc.has=tc.has,tc.set=tc.set,/* eslint-enable no-self-assign -- prototype methods protection */c=function(e,t){if(tc.has(e))throw to(ti);return t.facade=e,tc.set(e,t),t},s=function(e){return tc.get(e)||{}},u=function(e){return tc.has(e)}}else{var ts=tt("state");tn[ts]=!0,c=function(e,t){if(eL(e,ts))throw to(ti);return t.facade=e,ez(e,ts,t),t},s=function(e){return eL(e,ts)?e[ts]:{}},u=function(e){return eL(e,ts)}}var tu=(e5={set:c,get:s,has:u,enforce:function(e){return u(e)?s(e):c(e,{})},getterFor:function(e){return function(t){var r;if(!Q(t)||(r=s(t)).type!==e)throw to("Incompatible receiver, "+e+" required");return r}}}).enforce,tl=e5.get,tf=String,tp=Object.defineProperty,th=F("".slice),td=F("".replace),tv=F([].join),tg=j&&!O(function(){return 8!==tp(function(){},"length",{value:8}).length}),ty=String(String).split("String"),tm=e2=function(e,t,r){"Symbol("===th(tf(t),0,7)&&(t="["+td(tf(t),/^Symbol\(([^)]*)\)/,"$1")+"]"),r&&r.getter&&(t="get "+t),r&&r.setter&&(t="set "+t),(!eL(e,"name")||e7&&e.name!==t)&&(j?tp(e,"name",{value:t,configurable:!0}):e.name=t),tg&&r&&eL(r,"arity")&&e.length!==r.arity&&tp(e,"length",{value:r.arity});try{r&&eL(r,"constructor")&&r.constructor?j&&tp(e,"prototype",{writable:!1}):e.prototype&&(e.prototype=void 0)}catch(e){}var n=tu(e);return eL(n,"source")||(n.source=tv(ty,"string"==typeof t?t:"")),e};// add fake Function#toString for correct work wrapped methods / constructors with methods like LoDash isNative
// eslint-disable-next-line no-extend-native -- required
Function.prototype.toString=tm(function(){return K(this)&&tl(this).source||e8(this)},"toString"),e1=function(e,t,r,n){n||(n={});var i=n.enumerable,o=void 0!==n.name?n.name:t;if(K(r)&&e2(r,o,n),n.global)i?e[t]=r:eS(t,r);else{try{n.unsafe?e[t]&&(i=!0):delete e[t]}catch(e){}i?e[t]=r:a(e,t,{value:r,enumerable:!1,configurable:!n.nonConfigurable,writable:!n.nonWritable})}return e};var t_={},tb={},tw={},tE={},tS={},tj={},tO=Math.ceil,tL=Math.floor;// `Math.trunc` method
...
indexOf:t$(!1)}.indexOf,tF=F([].push);tw=function(e,t){var r,n=$(e),i=0,o=[];for(r in n)!eL(tn,r)&&eL(n,r)&&tF(o,r);// Don't enum bug & hidden keys
for(;t.length>i;)eL(n,r=t[i++])&&(~tI(o,r)||tF(o,r));return o};var tD=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"].concat("length","prototype");l=Object.getOwnPropertyNames||function(e){return tw(e,tD)},f=Object.getOwnPropertySymbols;var tq=F([].concat);// all object keys, includes non-enumerable and symbols
tb=et("Reflect","ownKeys")||function(e){var t=l(eW(e));return f?tq(t,f(e)):t},t_=function(e,t,n){for(var i=tb(t),o=0;o<i.length;o++){var c=i[o];eL(e,c)||n&&eL(n,c)||a(e,c,r(t,c))}};var tA={},tH=/#|\.prototype\./,tR=function(e,t){var r=tC[tN(e)];return r===tU||r!==tG&&(K(t)?O(t):!!t)},tN=tR.normalize=function(e){return String(e).replace(tH,".").toLowerCase()},tC=tR.data={},tG=tR.NATIVE="N",tU=tR.POLYFILL="P";tA=tR,/*
...
if(a=t[i],o=e.dontCallGetSet?(c=r(n,i))&&c.value:n[i],!tA(u?i:s+(l?".":"#")+i,e.forced)&&void 0!==o){if(typeof a==typeof o)continue;t_(a,o)}(e.sham||o&&o.sham)&&ez(a,"sham",!0),e1(n,i,a,e)}};var tz={},tB={},tW=Function.prototype,tY=tW.apply,tQ=tW.call;// eslint-disable-next-line es/no-reflect -- safe
...
if("Function"===H(e))return F(e)})(tV.bind);// optional / simple context binding
...
p=E.location});var ri=function(e){if(eL(rr,e)){var t=rr[e];delete rr[e],t()}},ro=function(e){return function(){ri(e)}},ra=function(e){ri(e.data)},rc=function(e){// old engines have not location.origin
...
a):a()}})}function O(e){var t={tryLoc:e[0]};1 in e&&(t.catchLoc=e[1]),2 in e&&(t.finallyLoc=e[2],t.afterLoc=e[3]),this.tryEntries.push(t)}function L(e){var t=e.completion||{};t.type="normal",delete t.arg,e.completion=t}function k(e){// The root entry object (effectively a try statement without a catch
...
}),rm.recipe.servings=e};var rS={};rS=new URL(b("27Lyk").resolve("eyyUD"),import.meta.url).toString();class rj{_data;//function to initialize _data
...
renderMessage(e=this._message){let t=`
    ...
    <figure class="recipe__fig">
      ...
      `}_addHandlerUpdatedServings(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--update-servings");if(!r)return;let{updateservingsto:n}=r.dataset;+n>0&&e(+n)})}}var rL=new rO;class rk{_parentEl=document.querySelector(".search");getQuery(){let e=this._parentEl.querySelector(".search__field").value;return this._clear(),e}_clear(){this._parentEl.querySelector(".search__field").value=""}addHandlerSearch(e){//we cannot directly use handler because when we submit a form page will reload so we need to prevent default action first.
this._parentEl.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rx=new rk;class rT extends rj{_parentElement=document.querySelector(".results");_errorMessage=" No recipes found .Try Again ";_message=" ";_generateMarkup(){return this._data.map(e=>this._generateMarkupPreview(e)).join("")}_generateMarkupPreview(e){return`
            <li class="preview">
...
async function rI(){try{let e=window.location.hash.slice(1);if(!e)return;rL.renderSpinner(),//loading recipe
await r_(e),rL.render(rm.recipe)}catch(e){rL.renderError()}}const rF=async function(){try{// get search query
let e=rx.getQuery();if(!e)return;rM.renderSpinner(),//load search results
await rb(e),rM.render(rw()),r$.render(rm.search)}catch(e){throw e}};rL.addHandlerRender(rI),rx.addHandlerSearch(rF),r$.addHandlerCLick(function(e){rM.render(rw(e)),r$.render(rm.search)}),rL._addHandlerUpdatedServings(function(e){//change state servings
rE(e),rL.render(rm.recipe)});//# sourceMappingURL=index.f8218793.js.map

//# sourceMappingURL=index.f8218793.js.map
