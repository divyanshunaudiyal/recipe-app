var e,t,r,n,i,o,a,c,s,u,l,f,p,h,d,v,g="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{};function y(e){return e&&e.__esModule?e.default:e}var m={},b={},_=g.parcelRequiree88c;null==_&&((_=function(e){if(e in m)return m[e].exports;if(e in b){var t=b[e];delete b[e];var r={id:e,exports:{}};return m[e]=r,t.call(r.exports,r,r.exports),r.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){b[e]=t},g.parcelRequiree88c=_);var w={},E={},S=function(e){return e&&e.Math===Math&&e};// https://github.com/zloirock/core-js/issues/86#issuecomment-115759028
...
function(){return this}()||E||Function("return this")();var j={},O={};// Detect IE8's incomplete defineProperty implementation
j=!(O=function(e){try{return!!e()}catch(e){return!0}})(function(){// eslint-disable-next-line es/no-object-defineproperty -- required for testing
return 7!==Object.defineProperty({},1,{get:function(){return 7}})[1]});var k={},L={};L=!O(function(){// eslint-disable-next-line es/no-function-prototype-bind -- safe
var e=(function(){}).bind();// eslint-disable-next-line no-prototype-builtins -- safe
return"function"!=typeof e||e.hasOwnProperty("prototype")});var x=Function.prototype.call;k=L?x.bind(x):function(){return x.apply(x,arguments)};var T={}.propertyIsEnumerable,M=Object.getOwnPropertyDescriptor;n=M&&!T.call({1:2},1)?function(e){var t=M(this,e);return!!t&&t.enumerable}:T;var P={};P=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var $={},I={},D={},F=Function.prototype,q=F.call,A=L&&F.bind.bind(q,q),H={},R=(D=L?A:function(e){return function(){return q.apply(e,arguments)}})({}.toString),N=D("".slice);H=function(e){return N(R(e),8,-1)};var C=Object,G=D("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
I=O(function(){// throws an error in rhino, see https://github.com/mozilla/rhino/issues/346
// eslint-disable-next-line no-prototype-builtins -- safe
return!C("z").propertyIsEnumerable(0)})?function(e){return"String"===H(e)?G(e,""):C(e)}:C;var U={},z={};// we can't use just `it == null` since of `document.all` special case
...
eh=function(e,t){var r=e[t];return z(r)?void 0:ed(r)};var em={},eb=TypeError;// `OrdinaryToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-ordinarytoprimitive
em=function(e,t){var r,n;if("string"===t&&K(r=e.toString)&&!Q(n=k(r,e))||K(r=e.valueOf)&&!Q(n=k(r,e))||"string"!==t&&K(r=e.toString)&&!Q(n=k(r,e)))return n;throw eb("Can't convert object to primitive value")};var e_={},ew={};ew=!1;var eE={},eS={},ej=Object.defineProperty;eS=function(e,t){try{ej(E,e,{value:t,configurable:!0,writable:!0})}catch(r){E[e]=t}return t};var eO="__core-js_shared__";eE=E[eO]||eS(eO,{}),(e_=function(e,t){return eE[e]||(eE[e]=void 0!==t?t:{})})("versions",[]).push({version:"3.32.2",mode:ew?"pure":"global",copyright:"\xa9 2014-2023 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.32.2/LICENSE",source:"https://github.com/zloirock/core-js"});var ek={},eL={},ex=Object;// `ToObject` abstract operation
// https://tc39.es/ecma262/#sec-toobject
eL=function(e){return ex(U(e))};var eT=D({}.hasOwnProperty);// `HasOwnProperty` abstract operation
// https://tc39.es/ecma262/#sec-hasownproperty
// eslint-disable-next-line es/no-object-hasown -- safe
ek=Object.hasOwn||function(e,t){return eT(eL(e),t)};var eM={},eP=0,e$=Math.random(),eI=D(1..toString);eM=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eI(++eP+e$,36)};var eD=E.Symbol,eF=e_("wks"),eq=en?eD.for||eD:eD&&eD.withoutSetter||eM,eA=TypeError,eH=(ek(eF,e="toPrimitive")||(eF[e]=ei&&ek(eD,e)?eD[e]:eq("Symbol."+e)),eF[e]);// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
Y=function(e,t){if(!Q(e)||ee(e))return e;var r,n=eh(e,eH);if(n){if(void 0===t&&(t="default"),r=k(n,e,t),!Q(r)||ee(r))return r;throw eA("Can't convert object to primitive value")}return void 0===t&&(t="number"),em(e,t)},// `ToPropertyKey` abstract operation
// https://tc39.es/ecma262/#sec-topropertykey
W=function(e){var t=Y(e,"string");return ee(t)?t:t+""};var eR={},eN={},eC=E.document,eG=Q(eC)&&Q(eC.createElement);eN=function(e){return eG?eC.createElement(e):{}},// Thanks to IE8 for its funny defineProperty
eR=!j&&!O(function(){// eslint-disable-next-line es/no-object-defineproperty -- required for testing
...
var eU=Object.getOwnPropertyDescriptor;r=j?eU:function(e,t){if(e=$(e),t=W(t),eR)try{return eU(e,t)}catch(e){}if(ek(e,t))return P(!k(n,e,t),e[t])};var ez={},eB={};// V8 ~ Chrome 36-
// https://bugs.chromium.org/p/v8/issues/detail?id=3334
eB=j&&O(function(){// eslint-disable-next-line es/no-object-defineproperty -- required for testing
...
eW=function(e){if(Q(e))return e;throw eQ(eY(e)+" is not an object")};var eK=TypeError,eV=Object.defineProperty,eJ=Object.getOwnPropertyDescriptor,eX="enumerable",eZ="configurable",e0="writable";a=j?eB?function(e,t,r){if(eW(e),t=W(t),eW(r),"function"==typeof e&&"prototype"===t&&"value"in r&&e0 in r&&!r[e0]){var n=eJ(e,t);n&&n[e0]&&(e[t]=r.value,r={configurable:eZ in r?r[eZ]:n[eZ],enumerable:eX in r?r[eX]:n[eX],writable:!1})}return eV(e,t,r)}:eV:function(e,t,r){if(eW(e),t=W(t),eW(r),eR)try{return eV(e,t,r)}catch(e){}if("get"in r||"set"in r)throw eK("Accessors not supported");return"value"in r&&(e[t]=r.value),e},ez=j?function(e,t,r){return a(e,t,P(1,r))}:function(e,t,r){return e[t]=r,e};var e1={},e2={},e4=Function.prototype,e3=j&&Object.getOwnPropertyDescriptor,e7=ek(e4,"name")&&(!j||j&&e3(e4,"name").configurable),e8={},e9=D(Function.toString);K(eE.inspectSource)||(eE.inspectSource=function(e){return e9(e)}),e8=eE.inspectSource;var e5={},e6={},te=E.WeakMap;e6=K(te)&&/native code/.test(String(te));var tt={},tr=e_("keys");tt=function(e){return tr[e]||(tr[e]=eM(e))};var tn={};tn={};var ti="Object already initialized",to=E.TypeError,ta=E.WeakMap;if(e6||eE.state){var tc=eE.state||(eE.state=new ta);/* eslint-disable no-self-assign -- prototype methods protection */tc.get=tc.get,tc.has=tc.has,tc.set=tc.set,/* eslint-enable no-self-assign -- prototype methods protection */c=function(e,t){if(tc.has(e))throw to(ti);return t.facade=e,tc.set(e,t),t},s=function(e){return tc.get(e)||{}},u=function(e){return tc.has(e)}}else{var ts=tt("state");tn[ts]=!0,c=function(e,t){if(ek(e,ts))throw to(ti);return t.facade=e,ez(e,ts,t),t},s=function(e){return ek(e,ts)?e[ts]:{}},u=function(e){return ek(e,ts)}}var tu=(e5={set:c,get:s,has:u,enforce:function(e){return u(e)?s(e):c(e,{})},getterFor:function(e){return function(t){var r;if(!Q(t)||(r=s(t)).type!==e)throw to("Incompatible receiver, "+e+" required");return r}}}).enforce,tl=e5.get,tf=String,tp=Object.defineProperty,th=D("".slice),td=D("".replace),tv=D([].join),tg=j&&!O(function(){return 8!==tp(function(){},"length",{value:8}).length}),ty=String(String).split("String"),tm=e2=function(e,t,r){"Symbol("===th(tf(t),0,7)&&(t="["+td(tf(t),/^Symbol\(([^)]*)\)/,"$1")+"]"),r&&r.getter&&(t="get "+t),r&&r.setter&&(t="set "+t),(!ek(e,"name")||e7&&e.name!==t)&&(j?tp(e,"name",{value:t,configurable:!0}):e.name=t),tg&&r&&ek(r,"arity")&&e.length!==r.arity&&tp(e,"length",{value:r.arity});try{r&&ek(r,"constructor")&&r.constructor?j&&tp(e,"prototype",{writable:!1}):e.prototype&&(e.prototype=void 0)}catch(e){}var n=tu(e);return ek(n,"source")||(n.source=tv(ty,"string"==typeof t?t:"")),e};// add fake Function#toString for correct work wrapped methods / constructors with methods like LoDash isNative
// eslint-disable-next-line no-extend-native -- required
Function.prototype.toString=tm(function(){return K(this)&&tl(this).source||e8(this)},"toString"),e1=function(e,t,r,n){n||(n={});var i=n.enumerable,o=void 0!==n.name?n.name:t;if(K(r)&&e2(r,o,n),n.global)i?e[t]=r:eS(t,r);else{try{n.unsafe?e[t]&&(i=!0):delete e[t]}catch(e){}i?e[t]=r:a(e,t,{value:r,enumerable:!1,configurable:!n.nonConfigurable,writable:!n.nonWritable})}return e};var tb={},t_={},tw={},tE={},tS={},tj={},tO=Math.ceil,tk=Math.floor;// `Math.trunc` method
// https://tc39.es/ecma262/#sec-math.trunc
// eslint-disable-next-line es/no-math-trunc -- safe
tj=Math.trunc||function(e){var t=+e;return(t>0?tk:tO)(t)},// `ToIntegerOrInfinity` abstract operation
// https://tc39.es/ecma262/#sec-tointegerorinfinity
tS=function(e){var t=+e;// eslint-disable-next-line no-self-compare -- NaN check
return t!=t||0===t?0:tj(t)};var tL=Math.max,tx=Math.min;// Helper for a popular repeating case of the spec:
// Let integer be ? ToInteger(index).
// If integer < 0, let result be max((length + integer), 0); else let result be min(integer, length).
tE=function(e,t){var r=tS(e);return r<0?tL(r+t,0):tx(r,t)};var tT={},tM={},tP=Math.min;// `ToLength` abstract operation
...
indexOf:t$(!1)}.indexOf,tD=D([].push);tw=function(e,t){var r,n=$(e),i=0,o=[];for(r in n)!ek(tn,r)&&ek(n,r)&&tD(o,r);// Don't enum bug & hidden keys
for(;t.length>i;)ek(n,r=t[i++])&&(~tI(o,r)||tD(o,r));return o};var tF=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"].concat("length","prototype");l=Object.getOwnPropertyNames||function(e){return tw(e,tF)},f=Object.getOwnPropertySymbols;var tq=D([].concat);// all object keys, includes non-enumerable and symbols
t_=et("Reflect","ownKeys")||function(e){var t=l(eW(e));return f?tq(t,f(e)):t},tb=function(e,t,n){for(var i=t_(t),o=0;o<i.length;o++){var c=i[o];ek(e,c)||n&&ek(n,c)||a(e,c,r(t,c))}};var tA={},tH=/#|\.prototype\./,tR=function(e,t){var r=tC[tN(e)];return r===tU||r!==tG&&(K(t)?O(t):!!t)},tN=tR.normalize=function(e){return String(e).replace(tH,".").toLowerCase()},tC=tR.data={},tG=tR.NATIVE="N",tU=tR.POLYFILL="P";tA=tR,/*
...
if(a=t[i],o=e.dontCallGetSet?(c=r(n,i))&&c.value:n[i],!tA(u?i:s+(l?".":"#")+i,e.forced)&&void 0!==o){if(typeof a==typeof o)continue;tb(a,o)}(e.sham||o&&o.sham)&&ez(a,"sham",!0),e1(n,i,a,e)}};var tz={},tB={},tW=Function.prototype,tY=tW.apply,tQ=tW.call;// eslint-disable-next-line es/no-reflect -- safe
tB="object"==typeof Reflect&&Reflect.apply||(L?tQ.bind(tY):function(){return tQ.apply(tY,arguments)});var tK={},tV={},tJ=(tV=function(e){// Nashorn bug:
//   https://github.com/zloirock/core-js/issues/1128
//   https://github.com/zloirock/core-js/issues/1130
if("Function"===H(e))return D(e)})(tV.bind);// optional / simple context binding
tK=function(e,t){return ed(e),void 0===t?e:L?tJ(e,t):function(){return e.apply(t,arguments)}};var tX={};tX=et("document","documentElement");var tZ={};tZ=D([].slice);var t0={},t1=TypeError;t0=function(e,t){if(e<t)throw t1("Not enough arguments");return e};var t2={};// eslint-disable-next-line redos/no-vulnerable -- safe
t2=/(?:ipad|iphone|ipod).*applewebkit/i.test(ea);var t4={};t4="process"===H(E.process);var t3=E.setImmediate,t7=E.clearImmediate,t8=E.process,t9=E.Dispatch,t5=E.Function,t6=E.MessageChannel,re=E.String,rt=0,rr={},rn="onreadystatechange";O(function(){// Deno throws a ReferenceError on `location` access without `--location` flag
p=E.location});var ri=function(e){if(ek(rr,e)){var t=rr[e];delete rr[e],t()}},ro=function(e){return function(){ri(e)}},ra=function(e){ri(e.data)},rc=function(e){// old engines have not location.origin
E.postMessage(re(e),p.protocol+"//"+p.host)};t3&&t7||(t3=function(e){t0(arguments.length,1);var t=K(e)?e:t5(e),r=tZ(arguments,1);return rr[++rt]=function(){tB(t,void 0,r)},h(rt),rt},t7=function(e){delete rr[e]},t4?h=function(e){t8.nextTick(ro(e))}:t9&&t9.now?h=function(e){t9.now(ro(e))}:t6&&!t2?(v=(d=new t6).port2,d.port1.onmessage=ra,h=tK(v.postMessage,v)):E.addEventListener&&K(E.postMessage)&&!E.importScripts&&p&&"file:"!==p.protocol&&!O(rc)?(h=rc,E.addEventListener("message",ra,!1)):h=rn in eN("script")?function(e){tX.appendChild(eN("script"))[rn]=function(){tX.removeChild(this),ri(e)}}:function(e){setTimeout(ro(e),0)});var rs=(tz={set:t3,clear:t7}).clear;// `clearImmediate` method
...
(b=w);var E=m.prototype=g.prototype=Object.create(b);// Helper for defining the .next, .throw, and .return methods of the
...
a):a()}})}function O(e){var t={tryLoc:e[0]};1 in e&&(t.catchLoc=e[1]),2 in e&&(t.finallyLoc=e[2],t.afterLoc=e[3]),this.tryEntries.push(t)}function k(e){var t=e.completion||{};t.type="normal",delete t.arg,e.completion=t}function L(e){// The root entry object (effectively a try statement without a catch
...
e.done=!0,e)}},e.values=x,L.prototype={constructor:L,reset:function(e){if(this.prev=0,this.next=0,// Resetting context._sent for legacy support of Babel's
// function.sent implementation.
this.sent=this._sent=t,this.done=!1,this.delegate=null,this.method="next",this.arg=t,this.tryEntries.forEach(k),!e)for(var r in this)"t"===r.charAt(0)&&n.call(this,r)&&!isNaN(+r.slice(1))&&(this[r]=t)},stop:function(){this.done=!0;var e=this.tryEntries[0].completion;if("throw"===e.type)throw e.arg;return this.rval},dispatchException:function(e){if(this.done)throw e;var r=this;function i(n,i){return c.type="throw",c.arg=e,r.next=n,i&&(// If the dispatched exception was caught by a catch block,
...
renderMessage(e=this._message){let t=`
      ...
      `;this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",t)}}class rO extends rj{_parentElement=document.querySelector(".recipe");_errorMessage=" Recipe couldn't be found ";_message=" ";addHandlerRender(e){["load","hashchange"].forEach(t=>window.addEventListener(t,e))}_generateMarkup(){return`
    <figure class="recipe__fig">
        ...
        <div class="recipe__details">
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${/*@__PURE__*/y(rS)}svg#icon-clock"></use>
            </svg>
          ...
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${/*@__PURE__*/y(rS)}svg#icon-users"></use>
            </svg>
            ...
            <div class="recipe__info-buttons">
              ...
              data-updateServingsTo="${this._data.servings-1}">
                <svg>
                  <use href="${/*@__PURE__*/y(rS)}svg#icon-minus-circle"></use>
                </svg>
              </button>
              <button id="increase" class="btn--tiny btn--update-servings"
              data-updateServingsTo="${this._data.servings+1}">
                <svg>
                  <use href="${/*@__PURE__*/y(rS)}svg#icon-plus-circle"></use>
                </svg>
              </button>
            </div>
          </div>
          ...
          <button class="btn--round">
            <svg class="">
              <use href="${/*@__PURE__*/y(rS)}svg#icon-bookmark-fill"></use>
            </svg>
          </button>
        </div>
        ...
        <div class="recipe__directions">
          ...
          >
            ...
            <svg class="search__icon">
              <use href="${/*@__PURE__*/y(rS)}svg#icon-arrow-right"></use>
            </svg>
          </a>
        </div>`}_generateMarkupIngredient(e){return`
        <li class="recipe__ingredient">
            <svg class="recipe__icon">
              <use href="${/*@__PURE__*/y(rS)}svg#icon-check"></use>
            </svg>
      ...
      `}_addHandlerUpdatedServings(e){this._parentElement.addEventListener("click",function(t){t.preventDefault();let r=t.target.closest(".btn--update-servings");if(!r)return;let{updateservingsto:n}=r.dataset;+n>0&&e(+n)})}}var rk=new rO;class rL{_parentEl=document.querySelector(".search");getQuery(){let e=this._parentEl.querySelector(".search__field").value;return this._clear(),e}_clear(){this._parentEl.querySelector(".search__field").value=""}addHandlerSearch(e){//we cannot directly use handler because when we submit a form page will reload so we need to prevent default action first.
this._parentEl.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rx=new rL;class rT extends rj{_parentElement=document.querySelector(".results");_errorMessage=" No recipes found .Try Again ";_message=" ";_generateMarkup(){return this._data.map(e=>this._generateMarkupPreview(e)).join("")}_generateMarkupPreview(e){return`
            <li class="preview">
            ...
            `}}var rM=new rT;class rP extends rj{_parentElement=document.querySelector(".pagination");_generateMarkup(){let e=this._data.page,t=Math.ceil(this._data.results.length/this._data.resultsPerPage);return(//page 1, there are more pages
1==e&&t>1?this._generateMarkupTextRight(e):e==t&&t>1?this._generateMarkupTextleft(e):e>1&&e<t?this._generateMarkupTextBoth(e):"")}_generateMarkupTextRight(e){return`
    ...
    `}_generateMarkupTextleft(e){return`
      ...
      <svg class="search__icon">
        <use href="${/*@__PURE__*/y(rS)}svg#icon-arrow-left"></use>
      </svg>
      <span>PAGE ${e-1}</span>
    </button>
   ...
   ${this._generateMarkupTextRight(e)}
    ...
    `}addHandlerCLick(e){document.querySelector(".pagination").addEventListener("click",function(t){t.preventDefault();let r=t.target.closest(".btn--inline");r&&// btn.innerText=PAGE 1,PAGE 2 ... PAGE N
e(+r.innerText.slice(5))})}}var r$=new rP;///////////////////////////////////////
async function rI(){try{let e=window.location.hash.slice(1);if(!e)return;rk.renderSpinner(),//loading recipe
await rb(e),rk.render(rm.recipe)}catch(e){rk.renderError()}}const rD=async function(){try{rM.renderSpinner();// get search query
let e=rx.getQuery();if(!e)return;//load search results
await r_(e),rM.render(rw()),r$.render(rm.search)}catch(e){throw e}};rk.addHandlerRender(rI),rx.addHandlerSearch(rD),r$.addHandlerCLick(function(e){rM.render(rw(e)),r$.render(rm.search)}),rk._addHandlerUpdatedServings(function(e){//change state servings
rE(e),rk.render(rm.recipe)});// init().then(() =>
//   recipeview._addHandlerUpdatedServings(
//     controlServings,
//     model.state.recipe.servings
//   )
// );
//# sourceMappingURL=index.e1ec702e.js.map
