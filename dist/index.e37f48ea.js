...
var _webImmediateJs = require("core-js/modules/web.immediate.js"); // init().then(() =>
...
const init = function() {
    ...
    (0, _recipeViewJsDefault.default)._addHandlerUpdatedServings(controlServings);
...
const timeout = function(s) {
    return new Promise(function(_, reject) {
        setTimeout(function() {
            reject(new Error(`Request took too long! Timeout after ${(0, _config.TIMEOUT_SECONDS)} second`));
        }, s * 1000);
    });
};
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    _errorMessage = " Recipe couldn't be found ";
    _message = " ";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:../../img/icons.svg":"loVOp","./view":"bWlJ9"}],"loVOp":[function(require,module,exports) {
...
class paginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (curPage == 1 && numPages > 1) return this._generateMarkupTextRight(curPage);
        //last page
        if (curPage == numPages && numPages > 1) return this._generateMarkupTextleft(curPage);
        //other page
...
},{"./view":"bWlJ9","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aD7Zm","aenu9"], "aenu9", "parcelRequiree88c")
